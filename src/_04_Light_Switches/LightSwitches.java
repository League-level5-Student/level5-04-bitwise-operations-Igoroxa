...
public class LightSwitches implements GameControlScene {
	...
	Color[] lightColors = { Color.BLUE, // 0
			Color.GREEN, // 1
			Color.RED, // 2
			Color.ORANGE, // 3
			Color.YELLOW, // 4
	...
	/*
	 * This method should only turn on 1 light, example: index = 4 // turn off
	...
	/*
	 * This method should only turn off 1 light index = 0 // turn off blue only (set
	 * bit 0 = 0)
	 */
	void turnLightOff(int index) {
		lightsOnOff = lightsOnOff & (0 << index);
	}
	...
	/*
	 * This method should be able to turn off multiple lights lightsBitmap =
	...
	/*
	 * This method should toggle the state of multiple lights example input:
	 * lightsOnOff = 0b10000001 // blue(0) and cyan(7) on lightsBitmap = 0b10011001
	 * // toggle lights 0, 3, 4, 7 output: lightsOnOff = 0b00011000 // blue(0) and
